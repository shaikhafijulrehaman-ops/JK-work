...
export default function BookingsPage() {
  ...
  const filteredBookings = bookings.filter(b => {
    ...
    if (activeTab === 'ACTIVE') return ['PENDING', 'PENDING_PARTNER_ACCEPTANCE', 'PARTNER_ACCEPTED', 'ASSIGNED', 'ARRIVED'].includes(b.status);
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className={`text-[9px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-md leading-none ${
                        ...
                        b.status === 'ARRIVED' ? 'bg-teal-100 text-teal-700 font-bold' :
                      ...
                      {selectedBooking.review || reviewSubmitted ? (
                        <div className="bg-slate-50 border border-slate-200/50 p-4 rounded-2xl space-y-3">
                          ...
                          {(selectedBooking.review?.customerOpinion || customerOpinion) && (
                            <div className="text-left bg-white p-3 rounded-xl border border-slate-100">
                              ...
                              <p className="text-slate-700 font-semibold italic text-xs leading-normal">
                                "{selectedBooking.review?.customerOpinion || customerOpinion}"
                              </p>
                            </div>
                          )}
                        ...
                        <form onSubmit={handleReviewSubmit} className="space-y-4 text-xs">
                          ...
                          <div className="form-group">
                            ...
                            ></textarea>
                            <label className="form-label">Customer Opinion (Optional)</label>
                          </div>
