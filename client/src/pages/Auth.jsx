...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-0 md:p-4 font-inter">
      ...
      <div 
        className="hidden md:block auth-container relative overflow-hidden bg-white w-[768px] max-w-full min-h-[520px] rounded-xl shadow-2xl transition-all duration-600 ease-in-out"
        style={{
      ...
      <div className="block md:hidden w-full min-h-screen flex flex-col bg-slate-950 text-slate-100 overflow-x-hidden relative">
        ...
        <div className="absolute top-[-10%] left-[-20%] w-[80vw] h-[80vw] max-w-[400px] max-h-[400px] bg-cyan-500/10 rounded-full blur-3xl animate-glow pointer-events-none"></div>
        <div className="absolute top-[20%] right-[-30%] w-[90vw] h-[90vw] max-w-[450px] max-h-[450px] bg-teal-500/10 rounded-full blur-3xl animate-glow pointer-events-none" style={{ animationDelay: '2s' }}></div>

        {/* 1. TOP SECTION: Premium Animated Branding/Welcome Panel */}
        <div className="h-[32vh] min-h-[220px] w-full flex flex-col justify-center items-center px-6 text-center relative z-10 select-none">
          ...
          <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-brand to-brand-light flex items-center justify-center shadow-lg shadow-cyan-500/20 mb-3 animate-float">
          ...
          {!isActive ? (
            <div className="space-y-1.5 animate-fade-up">
              ...
              <p className="text-sm text-cyan-200/80 max-w-[280px] mx-auto font-medium">
                Your trusted home services, just a tap away.
              </p>
              <div className="inline-flex items-center space-x-1.5 bg-cyan-950/60 border border-cyan-800/50 rounded-full px-3 py-1 mt-2">
            ...
            <div className="space-y-1.5 animate-fade-up">
              ...
              <div className="inline-flex items-center space-x-1.5 bg-cyan-950/60 border border-cyan-800/50 rounded-full px-3 py-1 mt-2">
                <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-ping"></span>
                <span className="text-[10px] font-semibold text-cyan-300 uppercase tracking-wider">Quick Registration</span>
              </div>
            </div>
          )}
        </div>

        {/* 2. BOTTOM SECTION: Forms inside Clean White Card stacked layout */}
        <div className="flex-grow w-full bg-white rounded-t-[2.5rem] px-8 pt-8 pb-10 flex flex-col justify-between relative z-10 shadow-[0_-15px_40px_-15px_rgba(8,145,178,0.2)]">
          <div className="w-full">
            ...
            {!isActive ? (
              ...
              !useOtp ? (
                ...
                /* OTP Mobile Login */
                <form onSubmit={otpSent ? handleVerifyOtp : handleSendOtp} className="animate-fade-up">
                  <div className="text-center mb-6">
              ...
              <form onSubmit={handleSignUp} className="animate-fade-up">
                ...
                <div className="space-y-4 mb-4">
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-3 flex items-center justify-between text-xs font-semibold">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <label className="flex items-center space-x-1.5 cursor-pointer text-slate-700">
                        <input 
                          ...
                          className="text-brand focus:ring-brand w-3.5 h-3.5"
                        />
                        <span className="text-brand">Worker</span>
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-8 text-center space-y-5">
            ...
            <div className="flex justify-center space-x-4">
              <button type="button" className="flex items-center justify-center w-10 h-10 rounded-full border border-slate-100 bg-white hover:bg-slate-50 text-slate-500 shadow-sm transition-all active:scale-95">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M12.24 10.285V13.4h6.887c-.648 2.41-2.519 4.1-5.136 4.1A5.72 5.72 0 0 1 8.2 11.8a5.72 5.72 0 0 1 5.79-5.7 5.66 5.66 0 0 1 4.07 1.68l2.5-2.4a9.124 9.124 0 0 0-6.57-2.78 9.2 9.2 0 0 0-9.2 9.2 9.2 9.2 0 0 0 9.2 9.2c5.03 0 9.1-3.6 9.1-9.2a8.67 8.67 0 0 0-.17-1.84Z"/>
                </svg>
              </button>
